// Flow: Add to Cart → Remove Item
// Path: Add items to cart → Remove item from cart
// Expected: SAT (should successfully add to cart and remove item)
...
static Program buildClientProgram()
{
    ...
    // add_to_cart(item, quantity) - First item
    {
        ...
        args.push_back(make_unique<Var>("3"));
