...
// ─────────────────────────────────────────────────────────────
//  Build the *customer client* Program AST for add_to_cart → place_order → view_orders
// ─────────────────────────────────────────────────────────────
static Program buildCustomerClientProgram()
{
    ...
    // add_to_cart(customerId, productId, quantity);
    {
...
// ─────────────────────────────────────────────────────────────
//  Build the Customer Ecommerce API *Spec* AST with add_to_cart/place_order/view_orders functionality
// ─────────────────────────────────────────────────────────────
static Spec buildCustomerEcommerceSpec()
{
    ...
    {
        /* pre: customerId ∈ dom(CUSTOMERS) && productId ∈ dom(PRODUCTS) && customerSessionToken ∈ dom(CUSTOMER_SESSIONS) */
        ...
        /* post: CARTS[customerId] = updated cart with new/modified item */
        ...
        cartItem.push_back(make_unique<Var>("productId"));
        cartItem.push_back(make_unique<Var>("quantity"));
        cartItem.push_back(make_unique<FuncCall>("current_time", vector<unique_ptr<Expr>>()));
        postArgs.push_back(make_unique<FuncCall>("updated_cart_with_item", move(cartItem)));
