...
// ─────────────────────────────────────────────────────────────
//  Build the *client* Program AST for register_student → authenticate → saveRequest → accept → saveBookStudent → getAllBooksOfStudent
// ─────────────────────────────────────────────────────────────
static Program buildClientProgram()
{
    ...
    // saveBookStudent(student_id, book_id);
    {
        vector<unique_ptr<Expr>> a;
    ...
    // getAllBooksOfStudent(student_id);
    {
        vector<unique_ptr<Expr>> a;
        a.push_back(make_unique<Var>("student_id"));
        stmts.push_back(make_unique<FuncCallStmt>(
              make_unique<FuncCall>("getAllBooksOfStudent", move(a))));
    }
...
// ─────────────────────────────────────────────────────────────
//  Build the API *Spec* AST with extended student library management functionality
// ─────────────────────────────────────────────────────────────
static Spec buildSpec()
{
    ...
    // --- Accept Request API block ---
    {
        ...
        postArgs.push_back(make_unique<Var>("accepted"));
        auto post = make_unique<FuncCall>("equals", move(postArgs));
    ...
    // --- Save Book Student API block ---
    {
        ...
        /* post: BS[student_id] contains book_id */
        vector<unique_ptr<Expr>> postArgs;
        {
            vector<unique_ptr<Expr>> idx;
        ...
        postArgs.push_back(make_unique<Var>("book_student_data"));
        auto post = make_unique<FuncCall>("equals", move(postArgs));
    ...
    {
        /* pre: student_token ∈ dom(ST) && student_id ∈ dom(BS) */
        vector<unique_ptr<Expr>> land;
        {
            vector<unique_ptr<Expr>> inDom;
            inDom.push_back(make_unique<Var>("ST"));
        ...
        {
            vector<unique_ptr<Expr>> inDom;
            inDom.push_back(make_unique<Var>("BS"));
        ...
        /* post: returns all books for student BS[student_id] */
        vector<unique_ptr<Expr>> postArgs;
        postArgs.push_back(make_unique<Var>("student_books_list"));
        {
            vector<unique_ptr<Expr>> idx;
            idx.push_back(make_unique<Var>("BS"));
            idx.push_back(make_unique<Var>("student_id"));
    ...
    globals.push_back(make_unique<Decl>(
        "R", make_unique<MapType>(
                 make_unique<TypeConst>("string"),
                 make_unique<TypeConst>("string"))));
    // Accepted requests map: A[request_id] = status
    globals.push_back(make_unique<Decl>(
        "A", make_unique<MapType>(
                 make_unique<TypeConst>("string"),
                 make_unique<TypeConst>("string"))));
    // Book Students map: BS[student_id] = book_students_data
    globals.push_back(make_unique<Decl>(
