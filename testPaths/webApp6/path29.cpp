...
// ─────────────────────────────────────────────────────────────
//  Build the *client* Program AST for authenticate(admin) → saveBook → updateBook → getAllBooks
// ─────────────────────────────────────────────────────────────
static Program buildAdminClientProgram()
{
    ...
    // book_data = input();   (new book data for update)
    {
        auto lhs = make_unique<Var>("book_data");
        vector<unique_ptr<Expr>> args;
        args.push_back(make_unique<Var>(""));
...
static Spec buildAdminSpec()
{
    ...
    // --- Save Book API block ---
    {
        ...
        }
        {
            ...
            notInDom.push_back(make_unique<Var>("book_id"));
            {
