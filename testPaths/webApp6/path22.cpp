...
// ─────────────────────────────────────────────────────────────
//  Build the *client* Program AST for register_student → authenticate → saveRequest → getAllRequests → getBookStudentsByStudentId
// ─────────────────────────────────────────────────────────────
static Program buildClientProgram()
{
    ...
    // getBookStudentsByStudentId(student_id);
    {
        vector<unique_ptr<Expr>> a;
...
static Spec buildSpec()
{
    ...
    // --- Get Book Students By Student ID API block ---
    {
        ...
        /* post: returns book students data BS[student_id] */
        vector<unique_ptr<Expr>> postArgs;
        postArgs.push_back(make_unique<Var>("book_students_data"));
        {
            vector<unique_ptr<Expr>> idx;
