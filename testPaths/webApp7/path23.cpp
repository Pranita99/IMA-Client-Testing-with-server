...
// ─────────────────────────────────────────────────────────────
//  Build the *client* Program AST for signup → login → get_restaurants → get_restaurant_menu
// ─────────────────────────────────────────────────────────────
...
static Spec buildSpec()
{
    ...
    // --- Get Restaurant Menu API block ---
    {
        ...
        /* post: returns menu for restaurant_id (simplified as R[restaurant_id] exists) */
        vector<unique_ptr<Expr>> postArgs;
        {
            vector<unique_ptr<Expr>> idx;
    ...
    // --- Get Cart API block ---
    {
        ...
        /* post: returns cart contents for current user */
        vector<unique_ptr<Expr>> postArgs;
        {
            vector<unique_ptr<Expr>> userIdx;
            userIdx.push_back(make_unique<Var>("T"));
