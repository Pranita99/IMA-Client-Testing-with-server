// Path 11:
// Plumber_Login → Accept_Assignment → Raise_Quotation (Valid path, should return SAT)
...
static Program buildClientProgram()
{
    ...
    // raise_quotation(assignment_id, plumber_id, estimated_cost, spare_parts_needed, work_description);
    {
        vector<unique_ptr<Expr>> a;
        a.push_back(make_unique<Var>("assignment_id"));
        a.push_back(make_unique<Var>("plumber_id"));
...
static Spec buildSpec()
{
    ...
    // --- raise_quotation ---
    {
        ...
        {
            vector<unique_ptr<Expr>> eq;
            eq.push_back(mapVal("QuotationDetails", "assignment_id"));
            eq.push_back(make_unique<Var>("estimated_cost"));
            postConj.push_back(make_unique<FuncCall>("equals", move(eq)));
        }
        {
            vector<unique_ptr<Expr>> eq;
            eq.push_back(mapVal("SpareParts", "assignment_id"));
            eq.push_back(make_unique<Var>("spare_parts_needed"));
            postConj.push_back(make_unique<FuncCall>("equals", move(eq)));
        }
        {
            vector<unique_ptr<Expr>> eq;
            eq.push_back(mapVal("WorkDescriptions", "assignment_id"));
    ...
    globals.push_back(make_unique<Decl>("QuotationDetails", make_unique<MapType>(
        make_unique<TypeConst>("string"), make_unique<TypeConst>("string"))));
    globals.push_back(make_unique<Decl>("SpareParts", make_unique<MapType>(
        make_unique<TypeConst>("string"), make_unique<TypeConst>("string"))));
    globals.push_back(make_unique<Decl>("WorkDescriptions", make_unique<MapType>(
        make_unique<TypeConst>("string"), make_unique<TypeConst>("string"))));
    ...
    globals.push_back(make_unique<Decl>("estimated_cost", make_unique<TypeConst>("string")));
    globals.push_back(make_unique<Decl>("spare_parts_needed", make_unique<TypeConst>("string")));
    ...
    // Initialize quotation tracking maps as empty
    inits.push_back(make_unique<Init>("QuotationDetails", 
        make_unique<Map>(vector<pair<unique_ptr<Var>,unique_ptr<Expr>>>())));
    inits.push_back(make_unique<Init>("SpareParts", 
        make_unique<Map>(vector<pair<unique_ptr<Var>,unique_ptr<Expr>>>())));
    inits.push_back(make_unique<Init>("WorkDescriptions", 
        make_unique<Map>(vector<pair<unique_ptr<Var>,unique_ptr<Expr>>>())));
