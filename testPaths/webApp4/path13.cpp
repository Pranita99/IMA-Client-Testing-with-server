// Path 13: Plumber_Login → View_Complaints → Accept_Assignment → Fill_Jobcard → Complete_Task
...
static Program buildClientProgram()
{
    ...
    // view_complaints(plumber_id);
    {
        vector<unique_ptr<Expr>> a;
        a.push_back(make_unique<Var>("plumber_id"));
        stmts.push_back(make_unique<FuncCallStmt>(
            make_unique<FuncCall>("view_complaints", move(a))));
    }
    ...
    // jobcard_details = input();
    {
        auto lhs = make_unique<Var>("jobcard_details");
        vector<unique_ptr<Expr>> a;
        a.push_back(make_unique<Var>(""));
        stmts.push_back(make_unique<Assign>(move(lhs),
            make_unique<FuncCall>("input", move(a))));
    ...
    // fill_jobcard(assignment_id, plumber_id, jobcard_details);
    {
        vector<unique_ptr<Expr>> a;
        a.push_back(make_unique<Var>("assignment_id"));
        a.push_back(make_unique<Var>("plumber_id"));
        a.push_back(make_unique<Var>("jobcard_details"));
        stmts.push_back(make_unique<FuncCallStmt>(
            make_unique<FuncCall>("fill_jobcard", move(a))));
    }
...
static Spec buildSpec()
{
    ...
    // --- view_complaints ---
    {
        ...
        auto callFn = make_unique<FuncCall>("view_complaints", move(args));

        vector<unique_ptr<Expr>> postConj;
        {
            vector<unique_ptr<Expr>> h;
            h.push_back(make_unique<Var>("plumber_id"));
            h.push_back(make_unique<Var>("ComplaintsList"));
            postConj.push_back(make_unique<FuncCall>("in", move(h)));
        }
        auto post = make_unique<FuncCall>("and_operator", move(postConj));
    ...
    // --- fill_jobcard ---
    {
        ...
        args.push_back(make_unique<Var>("assignment_id"));
        args.push_back(make_unique<Var>("plumber_id"));
        args.push_back(make_unique<Var>("jobcard_details"));
        auto callFn = make_unique<FuncCall>("fill_jobcard", move(args));

        vector<unique_ptr<Expr>> postConj;
        {
            vector<unique_ptr<Expr>> eq;
            eq.push_back(mapVal("Jobcards", "assignment_id"));
            eq.push_back(make_unique<Var>("jobcard_details"));
            postConj.push_back(make_unique<FuncCall>("equals", move(eq)));
        }
        auto post = make_unique<FuncCall>("and_operator", move(postConj));
    ...
    // --- complete_task ---
    {
        ...
        }
        {
            ...
            h.push_back(make_unique<Var>("Jobcards"));
    ...
    globals.push_back(make_unique<Decl>("PlumberLoginStatus", make_unique<MapType>(
        make_unique<TypeConst>("string"), make_unique<TypeConst>("string"))));
    globals.push_back(make_unique<Decl>("ComplaintsList", make_unique<MapType>(
        make_unique<TypeConst>("string"), make_unique<TypeConst>("string"))));
    ...
    globals.push_back(make_unique<Decl>("AssignmentPlumbers", make_unique<MapType>(
        make_unique<TypeConst>("string"), make_unique<TypeConst>("string"))));
    globals.push_back(make_unique<Decl>("Jobcards", make_unique<MapType>(
        make_unique<TypeConst>("string"), make_unique<TypeConst>("string"))));
    ...
    globals.push_back(make_unique<Decl>("jobcard_details", make_unique<TypeConst>("string")));
    ...
    inits.push_back(make_unique<Init>("ComplaintsList", make_unique<Map>(vector<pair<unique_ptr<Var>,unique_ptr<Expr>>>()))); 
    ...
    inits.push_back(make_unique<Init>("Jobcards", make_unique<Map>(vector<pair<unique_ptr<Var>,unique_ptr<Expr>>>()))); 
    inits.push_back(make_unique<Init>("TaskCompletionNotes", make_unique<Map>(vector<pair<unique_ptr<Var>,unique_ptr<Expr>>>()))); 
