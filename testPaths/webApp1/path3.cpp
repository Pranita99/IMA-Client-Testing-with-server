...
static Spec buildSpec()
{
    ...
    // login_notok
    {
        ...
        eq.push_back(mapVal("U", "username"));
        eq.push_back(make_unique<Var>("password"));
        ...
        ca.push_back(make_unique<Var>("username"));
        ca.push_back(make_unique<Var>("password"));
        auto call = make_unique<FuncCall>("login_notok", move(ca));

        vector<unique_ptr<Expr>> postEq;
        postEq.push_back(mapVal("T", "username"));
    ...
    // do_onboard
    {
        ...
        auto call = make_unique<FuncCall>("do_onboard", vector<unique_ptr<Expr>>{});
    ...
    // go_map
    {
        ...
        auto call = make_unique<FuncCall>("go_map", vector<unique_ptr<Expr>>{});
    ...
    // logout
    {
        ...
        preEq.push_back(mapVal("T", "username"));
    ...
    G.push_back(make_unique<Decl>("T",
        make_unique<MapType>(make_unique<TypeConst>("string"),
                             make_unique<TypeConst>("string"))));
    G.push_back(make_unique<Decl>("onboard", make_unique<TypeConst>("string")));
    G.push_back(make_unique<Decl>("location", make_unique<TypeConst>("string")));
    G.push_back(make_unique<Decl>("token", make_unique<TypeConst>("string")));
